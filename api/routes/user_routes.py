...
from utils.cookies import clear_tokens_cookies, set_access_token_cookie, set_refresh_token_cookie
...
@user_router.post(path = "/verify-email", status_code = status.HTTP_200_OK)
...
@user_router.post(path = "/forgot-password", status_code = status.HTTP_200_OK)
@limiter.limit("5/minute")
...
@user_router.post(path = "/reset-password", status_code = status.HTTP_200_OK)
@limiter.limit("5/minute")
